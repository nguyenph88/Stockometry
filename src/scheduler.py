...
def run_synthesis_and_save():
    ...
    """
    # Step 1: Generate the report string. The synthesizer will print it to the console.
    report_string = synthesize_analyses()
    
    # Step 2: If a report was successfully generated, process and save it.
    if report_string:
        processor = OutputProcessor(report_string)
